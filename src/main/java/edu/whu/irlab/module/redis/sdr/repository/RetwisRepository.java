package edu.whu.irlab.module.redis.sdr.repository;
...
import edu.whu.irlab.module.redis.sdr.util.KeyUtils;
...
public class RetwisRepository {
    ...
    @Autowired
    public RetwisRepository(RedisTemplate redisTemplate){
